...
public class RemoteUiAutomatorTestRunner implements IRemoteAndroidTestRunner {
    ...
    */
   private long mMaxTimeToOutputResponse = 0L;
   private TimeUnit mMaxTimeToOutputResponseUnits = TimeUnit.MILLISECONDS;
   ...
   @Override
   public void setMaxTimeToOutputResponse(long maxTimeToOutputResponse, TimeUnit timeUnit) {
      mMaxTimeToOutputResponse = maxTimeToOutputResponse;
      mMaxTimeToOutputResponseUnits = timeUnit;
   }
   ...
   public void run(Collection<ITestRunListener> listeners)
      ...
      try {
         mRemoteDevice.executeShellCommand(runCaseCommandStr, mParser, mMaxTimeToOutputResponse, mMaxTimeToOutputResponseUnits);
      } catch (IOException e) {
